...
func (in *ApplicationProtocolList) DeepCopyInto(out *ApplicationProtocolList) {
	*out = *in
	...
	if in.Items != nil {
		...
		*out = make([]ApplicationProtocol, len(*in))
		for i := range *in {
...
func (in *ApplicationProtocolList) DeepCopy() *ApplicationProtocolList {
	if in == nil {
		return nil
	}
	out := new(ApplicationProtocolList)
	in.DeepCopyInto(out)
	return out
}
