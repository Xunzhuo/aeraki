...
// ApplicationProtocols returns a ApplicationProtocolInformer.
func (v *version) ApplicationProtocols() ApplicationProtocolInformer {
	return &applicationProtocolInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}

// MetaRouters returns a MetaRouterInformer.
func (v *version) MetaRouters() MetaRouterInformer {
	return &metaRouterInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
