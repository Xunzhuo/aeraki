...
type DubboV1alpha1Interface interface {
	...
	DubboAuthorizationPoliciesGetter
}

// DubboV1alpha1Client is used to interact with features provided by the dubbo.aeraki.io group.
type DubboV1alpha1Client struct {
	restClient rest.Interface
}

func (c *DubboV1alpha1Client) DubboAuthorizationPolicies(namespace string) DubboAuthorizationPolicyInterface {
	return newDubboAuthorizationPolicies(c, namespace)
}
