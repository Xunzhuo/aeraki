...
var redisdestinationsResource = schema.GroupVersionResource{Group: "redis.aeraki.io", Version: "v1alpha1", Resource: "redisdestinations"}

var redisdestinationsKind = schema.GroupVersionKind{Group: "redis.aeraki.io", Version: "v1alpha1", Kind: "RedisDestination"}
...
func (c *FakeRedisDestinations) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.RedisDestination, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(redisdestinationsResource, c.ns, name), &v1alpha1.RedisDestination{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.RedisDestination), err
}

// List takes label and field selectors, and returns the list of RedisDestinations that match those selectors.
func (c *FakeRedisDestinations) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.RedisDestinationList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(redisdestinationsResource, redisdestinationsKind, c.ns, opts), &v1alpha1.RedisDestinationList{})
	...
	list := &v1alpha1.RedisDestinationList{ListMeta: obj.(*v1alpha1.RedisDestinationList).ListMeta}
	for _, item := range obj.(*v1alpha1.RedisDestinationList).Items {
...
func (c *FakeRedisDestinations) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(redisdestinationsResource, c.ns, opts))
...
func (c *FakeRedisDestinations) Create(ctx context.Context, redisDestination *v1alpha1.RedisDestination, opts v1.CreateOptions) (result *v1alpha1.RedisDestination, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(redisdestinationsResource, c.ns, redisDestination), &v1alpha1.RedisDestination{})
...
func (c *FakeRedisDestinations) Update(ctx context.Context, redisDestination *v1alpha1.RedisDestination, opts v1.UpdateOptions) (result *v1alpha1.RedisDestination, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(redisdestinationsResource, c.ns, redisDestination), &v1alpha1.RedisDestination{})
...
func (c *FakeRedisDestinations) UpdateStatus(ctx context.Context, redisDestination *v1alpha1.RedisDestination, opts v1.UpdateOptions) (*v1alpha1.RedisDestination, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(redisdestinationsResource, "status", c.ns, redisDestination), &v1alpha1.RedisDestination{})
...
func (c *FakeRedisDestinations) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(redisdestinationsResource, c.ns, name), &v1alpha1.RedisDestination{})
...
func (c *FakeRedisDestinations) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(redisdestinationsResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.RedisDestinationList{})
	return err
}
...
func (c *FakeRedisDestinations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.RedisDestination, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(redisdestinationsResource, c.ns, name, pt, data, subresources...), &v1alpha1.RedisDestination{})
